...
<head>
    ...
    <title>Berita Shidokan Nasional</title>
</head>
<body>
    <!-- Navbar -->
            ...
            <div class="collapse navbar-collapse" id="navbarNav">
                <ul class="navbar-nav">
                    ...
                    <ul class="dropdown-menu active" aria-labelledby="newsDropdown">
                        ...
                        <li><a class="dropdown-item active" href="#">&nbsp;National</a></li>
    ...
    <!-- Header Title & Sub -->
    <div class="banner bannerimage banner_beritaNasional">
        <div class="banner-content">
            <h1>Berita Nasional Shidokan</h1>
            <p>Berita seputar Event & Aktivitas Shidokan Kyokushin di Indonesia</p>
        </div>
    </div>
    <!-- Isi -->
    <div class="container">
        ...
        untuk Berita Nasional Shidokan Indonesia
        -->
