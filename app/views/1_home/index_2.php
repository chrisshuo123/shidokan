...
<body>
    ...
    <div id="customCarousel" class="carousel slide" data-bs-ride="carousel">
        ...
        <div class="carousel-inner">
            <div class="carousel-item active">
                <div class="carousel-image carousel-karateguyimage"></div>
            ...
            <div class="carousel-item">
                <div class="carousel-image" style="background-image: url('../img/1-banner/banner-sample-2.jpg');"></div>
            ...
            <div class="carousel-item">
                <div class="carousel-image" style="background-image: url('../img/1-banner/banner-sample-1.jpg');"></div>
        ...
        <div class="katalog-layout">
            ...
            <div class="row justify-content-md-center justify-content-center text-center" style="margin-left:1.5%;">
                <div class="catalog-btn col-lg-4 col-md-5 col-5" data-link="#">
                    <img src="../img/3-katalog/dojoBuilding1.png" class="img-fluid">
                    <p>Yuan Surabaya Barat</p>
                </div>
                <div class="catalog-btn col-lg-4 col-md-5 col-5" data-link="#">
                    <img src="../img/3-katalog/dojoBuilding2.png" class="img-fluid">
                    <p>Shidokan Denpasar Bali</p>
                </div>
                <div class="catalog-btn col-lg-4 col-md-5 col-5" data-link="#">
                    <img src="../img/3-katalog/dojoBuilding3.png" class="img-fluid">
                    <p>Yuan Surabaya Barat</p>
                </div>
                <div class="catalog-btn col-lg-4 col-md-5 col-5" data-link="#">
                    <img src="../img/3-katalog/dojoBuilding4.png" class="img-fluid">
                    <p>Shidokan Denpasar Bali</p>
                </div>
            </div>
        </div>
        ...
        <div class="our-partner font-responsive">
            ...
            <div class="row justify-content-md-center justify-content-center text-center">
                ...
                <div class="logo_dataLink col-md-2 col-5" style="padding:0; margin-right:3%; margin-bottom: 2%;" data-link="#">
                    <img src="../img/5-partner/tokoemas.png" class="img-fluid">
                    <p>Toko Emas</p>
                </div>
                <div class="logo_dataLink col-md-2 col-5" style="padding:0; margin-right:3%; margin-bottom: 2%;" data-link="#">
                    <img src="../img/5-partner/uc1000.png" class="img-fluid">
                    <p>You C-1000</p>
                </div>
                <div class="logo_dataLink col-md-2 col-5" style="padding:0; margin-right:3%; margin-bottom: 2%;" data-link="#">
                    <img src="../img/5-partner/tokoemas.png" class="img-fluid">
        ...
        <div class="merchandise">
            ...
            <div class="row justify-content-md-center justify-content-center text-center">
                <div class="col-md-3 col-5" style="padding:0; margin-right:3%;">
                    <img src="../img/6-merchandise/uc1000_merchandise.png" class="img-fluid">
                </div>
                <div class="col-md-3 col-5" style="padding:0; margin-right:3%;">
                    <img src="../img/6-merchandise/tomoemas1_merchandise.png" class="img-fluid">
                </div>
                <div class="col-md-3 col-5" style="padding:0; margin-right:3%;">
                    <img src="../img/6-merchandise/tokoemas2_merchandise.png" class="img-fluid">
                </div>
            </div>
        </div>
    </div>
    ...
    <script src="../../3_JavaScript/carouselHome.js"></script>
    <script src="../../3_JavaScript/navbar2.1.js"></script>
    ...
    <script type="text/javascript" src="navbarBabel.js"></script>
